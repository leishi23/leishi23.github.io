...
int main(){
    ...
    allocateSpace(tArray, len);     //here we use value pass, because array is special, which means <span style="color:blue">arrays will be turned into pointer  in function parameters automatically. </span>
